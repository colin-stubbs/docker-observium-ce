...
then
   ...
   test -r /opt/observium/scripts/alerting.sql && mysql -h $OBSERVIUM_DB_HOST -u $OBSERVIUM_DB_USER --password=$OBSERVIUM_DB_PASS $OBSERVIUM_DB_NAME < /opt/observium/scripts/alerting.sql
